...
//
// Page for quick check: https://www.cwa.gov.tw/V8/C/W/OBS_UVI.html
val CWA_UV_STATIONS = mapOf<String, Map<String, Double>>(
    "466881" to mapOf("lat" to 24.959328, "lon" to 121.52433),  // 新北
    "466900" to mapOf("lat" to 25.164888, "lon" to 121.448906), // 淡水
    "466910" to mapOf("lat" to 25.182587, "lon" to 121.52973),  // 鞍部
    "466920" to mapOf("lat" to 25.037659, "lon" to 121.514854), // 臺北
    "466930" to mapOf("lat" to 25.162079, "lon" to 121.54455),  // 陽明山
    "466940" to mapOf("lat" to 25.133314, "lon" to 121.74048),  // 基隆
    "466950" to mapOf("lat" to 25.627975, "lon" to 122.07974),  // 彭佳嶼
    "466990" to mapOf("lat" to 23.975128, "lon" to 121.61327),  // 花蓮
    "467050" to mapOf("lat" to 25.006744, "lon" to 121.047485), // 新屋
    "467080" to mapOf("lat" to 24.763975, "lon" to 121.75653),  // 宜蘭
    "467110" to mapOf("lat" to 24.407307, "lon" to 118.28928),  // 金門
    "467270" to mapOf("lat" to 23.873802, "lon" to 120.58128),  // 田中
    "467300" to mapOf("lat" to 23.25695, "lon" to 119.667465),  // 東吉島
    "467350" to mapOf("lat" to 23.565502, "lon" to 119.563095), // 澎湖
    "467410" to mapOf("lat" to 22.993238, "lon" to 120.20477),  // 臺南
    "467420" to mapOf("lat" to 23.038385, "lon" to 120.2367),   // 永康
    "467441" to mapOf("lat" to 22.730433, "lon" to 120.312515), // 高雄
    "467480" to mapOf("lat" to 23.495926, "lon" to 120.43291),  // 嘉義
    "467490" to mapOf("lat" to 24.145737, "lon" to 120.684074), // 臺中
    "467530" to mapOf("lat" to 23.508207, "lon" to 120.81324),  // 阿里山
    "467540" to mapOf("lat" to 22.355675, "lon" to 120.903786), // 大武
    "467550" to mapOf("lat" to 23.487614, "lon" to 120.95952),  // 玉山
    "467571" to mapOf("lat" to 24.827852, "lon" to 121.01422),  // 新竹
    "467590" to mapOf("lat" to 22.003897, "lon" to 120.74634),  // 恆春
    "467610" to mapOf("lat" to 23.097486, "lon" to 121.37343),  // 成功
    "467620" to mapOf("lat" to 22.036968, "lon" to 121.55834),  // 蘭嶼
    "467650" to mapOf("lat" to 23.881325, "lon" to 120.90805),  // 日月潭
    "467660" to mapOf("lat" to 22.75221, "lon" to 121.15459),   // 臺東
    "467990" to mapOf("lat" to 26.16927, "lon" to 119.923416)   // 馬祖
)
